...
import type { CompFeedbackPayload, CompFeedbackRating } from "@/comp-tool/types";
...
export async function POST(request: Request) {
  ...
  if (!feedback.artifactPath) {
    return NextResponse.json({ error: "Missing artifactPath for the evaluated comp." }, { status: 400 });
  }
